...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "proxy_btn_activate":        "Activate",
        "proxy_btn_deactivate":      "Deactivate",
        "proxy_activated_msg":       "MPC Proxy activated.\n\nConfig written to:\n{path}\n\nA backup of the original config was created.",
        "proxy_deactivated_restored":"MPC Proxy deactivated.\nOriginal config restored from backup.",
        "proxy_deactivated_removed": "MPC Proxy deactivated.\n(No backup existed \u2014 config file removed.)",
        "proxy_bak_hint":            "Original config is backed up automatically on first setup.",
    },
    ...
    "de": {
        ...
        "proxy_status_active":       "\u25cf Aktiv",
        "proxy_status_inactive":     "\u25cb Inaktiv",
        "proxy_btn_activate":        "Aktivieren",
        "proxy_btn_deactivate":      "Deaktivieren",
        "proxy_activated_msg":       "MPC Proxy aktiviert.\n\nKonfiguration geschrieben nach:\n{path}\n\nEin Backup der Original-Konfiguration wurde angelegt.",
        "proxy_deactivated_restored":"MPC Proxy deaktiviert.\nOriginale Konfiguration aus Backup wiederhergestellt.",
        "proxy_deactivated_removed": "MPC Proxy deaktiviert.\n(Kein Backup vorhanden \u2014 Konfigurationsdatei gel\u00f6scht.)",
        "proxy_bak_hint":            "Die Original-Konfiguration wird beim ersten Einrichten automatisch gesichert.",
    },
    ...
    "fr": {
        ...
        "proxy_status_active":       "\u25cf Actif",
        "proxy_status_inactive":     "\u25cb Inactif",
        "proxy_btn_activate":        "Activer",
        "proxy_btn_deactivate":      "D\u00e9sactiver",
        "proxy_activated_msg":       "MPC Proxy activ\u00e9.\n\nConfiguration \u00e9crite dans\u00a0:\n{path}\n\nUne sauvegarde de la configuration originale a \u00e9t\u00e9 cr\u00e9\u00e9e.",
        "proxy_deactivated_restored":"MPC Proxy d\u00e9sactiv\u00e9.\nConfiguration originale restaur\u00e9e depuis la sauvegarde.",
        "proxy_deactivated_removed": "MPC Proxy d\u00e9sactiv\u00e9.\n(Pas de sauvegarde \u2014 fichier de configuration supprim\u00e9.)",
        "proxy_bak_hint":            "La configuration originale est sauvegard\u00e9e automatiquement lors du premier param\u00e9trage.",
    },
    ...
    "es": {
        ...
        "proxy_status_active":       "\u25cf Activo",
        "proxy_status_inactive":     "\u25cb Inactivo",
        "proxy_btn_activate":        "Activar",
        "proxy_btn_deactivate":      "Desactivar",
        "proxy_activated_msg":       "MPC Proxy activado.\n\nConfiguración escrita en:\n{path}\n\nSe ha creado una copia de seguridad de la configuración original.",
        "proxy_deactivated_restored":"MPC Proxy desactivado.\nConfiguración original restaurada desde la copia de seguridad.",
        "proxy_deactivated_removed": "MPC Proxy desactivado.\n(Sin copia de seguridad \u2014 archivo de configuraci\u00f3n eliminado.)",
        "proxy_bak_hint":            "La configuraci\u00f3n original se guarda autom\u00e1ticamente en el primer uso.",
    },
    ...
    "it": {
        ...
        "proxy_status_active":       "\u25cf Attivo",
        "proxy_status_inactive":     "\u25cb Inattivo",
        "proxy_btn_activate":        "Attiva",
        "proxy_btn_deactivate":      "Disattiva",
        "proxy_activated_msg":       "MPC Proxy attivato.\n\nConfigurazione scritta in:\n{path}\n\n\u00c8 stato creato un backup della configurazione originale.",
        "proxy_deactivated_restored":"MPC Proxy disattivato.\nConfigurazione originale ripristinata dal backup.",
        "proxy_deactivated_removed": "MPC Proxy disattivato.\n(Nessun backup disponibile \u2014 file di configurazione rimosso.)",
        "proxy_bak_hint":            "La configurazione originale viene salvata automaticamente al primo utilizzo.",
    },
}
